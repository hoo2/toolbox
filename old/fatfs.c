...
/*-----------------------------------------------------------------------*/
/* Use libc to get time and convert it to fattime                        */
/*-----------------------------------------------------------------------*/
#if !_FS_READONLY
DWORD get_fattime (void)
{
   ...
   res =  ((DWORD)((loctime->tm_year - 1980) << 25))
         | ((DWORD)(loctime->tm_mon << 21))
         | ((DWORD)(loctime->tm_mday << 16))
         | ((WORD)(loctime->tm_hour << 11))
         | ((WORD)(loctime->tm_min << 5))
         | ((WORD)(loctime->tm_sec >> 1));
   return res;
}
#endif
