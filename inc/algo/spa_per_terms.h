 ...
 * spa_per_terms.h
 *
 *  Created on: 14 Σεπ 2016
 *      Author: hoo2
 */

#ifndef __spa_per_terms_h__
#define __spa_per_terms_h__


enum { TERM_A=0, TERM_B, TERM_C, TERM_COUNT};
enum { TERM_X0=0, TERM_X1, TERM_X2, TERM_X3, TERM_X4, TERM_X_COUNT};
enum { TERM_PSI_A=0, TERM_PSI_B, TERM_EPS_C, TERM_EPS_D, TERM_PE_COUNT};
enum { JD_MINUS=0, JD_ZERO, JD_PLUS, JD_COUNT};
enum { SUN_TRANSIT=0, SUN_RISE, SUN_SET, SUN_COUNT};
